...
$DATA nonmem_bayes_input.csv IGNORE = C
...
$TABLE ID TIME AMT RATE A1 A2 CL V1 Q V2 IPRE WT ADA ALB ETA1 PPVCL ETA2 PPVV1 ETA3 PPVQ ETA4 PPVV2 NOPRINT ONEHEADER FILE = *.fit
