...
$DATA ..\nonmem_simulation_input.csv IGNORE=C
...
$TABLE ID TIME AMT RATE A1 A2 CL V1 Q V2 IPRE WT ADA ALB PPVCL PPVV1 PPVQ PPVV2 NOPRINT ONEHEADER FILE=nonmem_simulation_infliximab.fit
