...
# Line (median) and ribbon (prediction intervals)
  # Calculate
    wt.summary.data <- ddply(collect.trough.data, .(STUDY,time), function(all.data) summary.function(all.data$WTCOV))
...
# Line (median) and ribbon (prediction intervals)
# Calculate
  alb.summary.data <- ddply(collect.trough.data, .(STUDY,time), function(all.data) summary.function(all.data$ALBCOV))
