		...
		# Should have the previous doses
			bayes.eta <- function(ID.data) {
				...
				# Run bayes.estimate function
					bayes.result <- optim(par,bayes.estimate,hessian = FALSE,method = "L-BFGS-B",lower = c(0.0001,0.0001,0.0001,0.0001),upper = c(Inf,Inf,Inf,Inf),control = list(parscale = par,factr = 1e7))
