...
# Set up an input data frame for optimisation algorithm and differential equation solver
	input.optimise.data <- data.frame(
		...
		ALB = 3.622388235,	# Albumin (g/dL)
		ADA = 1,	# Anti-drug antibodies
		ETA1 = 0.818365048,	# ETA for CL
		ETA2 = 0.0442064,	# ETA for V1
		ETA3 = -0.409030708,	# ETA for Q
		ETA4 = -1.805818079,	# ETA for V2
		ERRPRO = -0.19761816,	# Random effect for residual error
